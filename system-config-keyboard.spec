...
* Tue Jul 09 2013 Nils Philippsen <nils@redhat.com> - 1.4.0-1
- version 1.4.0
...
* Mon May 13 2013 Nils Philippsen <nils@redhat.com> - 1.3.1-13
- fix syntax errors in polkit policy file

* Thu Apr 18 2013 Nils Philippsen <nils@redhat.com> - 1.3.1-12
- use consistent names for patches, create backup files
- use polkit/pkexec instead of consolehelper
- add man page

* Fri Feb 15 2013 Ville Skyttä <ville.skytta@iki.fi> - 1.3.1-11
- Add dependency on newt-python (#845391, Sandro Mani).
- Fix bogus dates in %%changelog and rpmlint tabs vs spaces warning.

* Fri Feb 15 2013 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.3.1-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_19_Mass_Rebuild

* Sat Jul 21 2012 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.3.1-9
